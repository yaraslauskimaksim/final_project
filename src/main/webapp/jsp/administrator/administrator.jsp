        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
          <ul class="navbar-nav mr-auto">
           ...
           <li class="nav-item dropdown">
                   ...
                   <a class="dropdown-item" href="${_contextPath}/frontController?command=show">Comments</a>
                </div>
           </li>
          </ul>
          ...
          <form class="form-inline mt-2 mt-md-2">
            <a type="button" class="btn btn-danger" href="${_contextPath}/frontController?command=local&adr=${pageContext.request.requestURI}&lang=ru">RU</a>
            <a type="button" class="btn btn-danger" href="${_contextPath}/frontController?command=local&adr=${pageContext.request.requestURI}&lang=en">EN</a>
          </form>
        </div>
      </nav>
    </header>
